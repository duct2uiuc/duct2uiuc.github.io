...
Topics are extracted from each project's **Project Description** using topic extraction techniques. The resulting data is then aggregated by year, with topics ranked according to their frequency within each respective year.
